...
public class CommonConstants {
    public final static String FILE_PATH = "files\\people_information.txt";

    public final static String ARRAY_DELIMITER1 = " , ";
    public final static String ARRAY_DELIMITER2 = ":";
